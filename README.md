...
In this case you also need to change value of DEBOUNCE_DELAY_MS constant from 100 to 350, this is required to handle Contact Bounce issue (you can read about it on internet).
